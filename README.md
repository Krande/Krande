...
- 🔭 I’m currently working on porting Code Aster to MSVC and distribute it as a conda-forge package (see https://gitlab.com/krande/src).
  This will to let those of us forced to use Windows in our day-jobs enjoy the wonderful Finite Element solver directly from inside our python environment
